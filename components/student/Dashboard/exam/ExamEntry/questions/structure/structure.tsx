...
export function StructuredQuestion({
  ...
  return (
    <div className="fixed inset-0 w-full h-screen z-50 flex flex-col items-center p-6 bg-white dark:bg-black text-black dark:text-white">
      ...
      <div className="mt-6 w-full max-w-7xl flex-1 flex flex-col md:flex-row gap-6 mb-6">
      ...
      <div className="w-full max-w-7xl flex justify-between items-end mb-6">
        {/* Camera preview */}
        <div className="relative">
          <div className="w-[180px] h-[135px] rounded-lg overflow-hidden border-2 border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 shadow-md">
