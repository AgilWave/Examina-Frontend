...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className="bg-card rounded-xl border data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down overflow-hidden text-sm text-foreground"
      {...props}
    >
