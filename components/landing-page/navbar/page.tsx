        ...
        <div className="flex flex-col items-center justify-center h-full space-y-8 p-4 text-xl">
          {navItems.map((item) => (
            <div
              ...
              onClick={closeMenu}
            >
              <span className="transition-transform duration-300 inline-block group-hover:translate-y-[-100%]">
                {item}
              </span>
              <span className="absolute top-[100%] left-0 transition-transform duration-300 inline-block group-hover:translate-y-[-100%]">
                {item}
              </span>
