...
function HeroSection() {
  return (
    <div className="flex flex-col items-center md:justify-center w-full min-h-screen bg-black mt-14 gap-3">
      <div className="relative bg-white rounded-3xl md:rounded-[50px] overflow-hidden w-full h-[70%] md:h-[85%] max-w-6xl mx-auto p-4 md:p-8 shadow-lg">
        ...
        <div className="absolute bottom-0 left-0 right-0 overflow-hidden" style={{ height: "400px" }}>
          <motion.div 
            initial={{ y: 500 }} 
            animate={{ y: 0 }} 
            transition={{ duration: 1.5, ease: "easeOut" }}
            className="absolute left-1/2 transform -translate-x-1/2 -bottom-4 w-[95%] h-[320px] md:h-[210px] xl:h-[230px] 2xl:h-[400px] bg-zinc-800 rounded-t-[33px] md:rounded-t-[63px] border-[12px] border-zinc-900 overflow-hidden"
          >
            <Image 
              src={DashbardImg} 
              alt="Dashboard" 
