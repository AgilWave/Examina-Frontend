...
export default function ExamDashboard() {
  ...
  const cw: Exam[] = Array(9).fill(null).map((_, i) => ({
    id: `exam-${i + 1}`,
    ...
    status: 
      i % 3 === 0 ? 'Ongoing' : 
      i % 3 === 1 ? 'Pending' : 'Ended',
    type: i % 2 === 0 ? 'Coursework' : 'Assignment'
  }))
  ...
  const applyFilters = () => {
    const filtered = cw.filter(cw => {
      if (selectedExamType === "all") return true;
      if (selectedExamType === "final") return cw.type === "Coursework";
      if (selectedExamType === "mid") return cw.type === "Assignment";
      return true;
    });
  ...
  const getTypeColors = (type: string) => {
    switch(type) {
      case 'Coursework':
        return { bg: 'bg-[#00008050]', text: 'text-[#0000FF]' }
      case 'Assignment': 
        return { bg: 'bg-[#02302050]', text: 'text-[#008000]' }
      default:
    ...
    <div className="h-fit bg-gradient-to-br text- dark:text-white p-1 md:p-8">
        <div className="flex flex-col gap-2">
            ...
            <p className="text-black/80 dark:text-gray-400 text-sm">
              Manage your courseworks, view courseworks details, and create new courseworks.
            </p>
          </div>
              ...
              <div>
                ...
                <Select onValueChange={handleFilterChange} value={selectedExamType}>
                    ...
                    <SelectContent className='bg-white dark:bg-black dark:text-white text-black border-teal-600'>
                        ...
                        <SelectItem value="final">Coursework</SelectItem>
                        <SelectItem value="mid">Assignment</SelectItem>
                    </SelectContent>
                </Select>
