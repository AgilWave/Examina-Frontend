...
const AdminContent: FC = () => {
  const items = [
    { icon: <UsersRound  size={30} color="#FFFFFF" />, title: "Users", link: "/admin/dashboard/admin/users" },
    { icon: <FileClock   size={30} color="#FFFFFF" />, title: "Logs", link: "/admin/dashboard/admin/logs" },
    { icon: <UserRoundCog   size={30} color="#FFFFFF" />, title: "Students", link: "/admin/dashboard/admin/students" },
  ];
