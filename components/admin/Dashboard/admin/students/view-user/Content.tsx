      ...
      <div className="flex w-full flex-col gap-3 sm:gap-5">
        <Tabs defaultValue="details" className="w-full">
          <div className="border-slate-200 dark:border-slate-700 border-b-2">
            <TabsList isLoading={isLoading} loadingItems={2} className="bg-transparent h-10 sm:h-12 p-1 sm:p-2">
          ...
          <TabsContent isLoading={isLoading} value="details">
            <UserDetails />
          </TabsContent>
          <TabsContent isLoading={isLoading} value="settings" >
              <SystemDetails/>
          </TabsContent>
        </Tabs>
      </div>
