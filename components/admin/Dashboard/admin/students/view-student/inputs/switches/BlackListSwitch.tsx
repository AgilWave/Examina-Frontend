...
function BlackListSwitch() {
  ...
  useEffect(() => {
    if (student.viewStudent && student.viewStudent.isBlacklisted !== undefined) {
      setIsBlacklisted(student.viewStudent.isBlacklisted);
    }
  }, [student]);
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      if (response.data.isSuccessful) {
        ...
        setIsBlacklisted(isBlacklistAction); 
      } else {
        ...
        <div className="flex items-center flex-col space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 text-center">
              {isBlacklisted
                ? "Student is currently blacklisted"
                : "Student has normal access"}
            </p>
          </div>
        </div>
        ...
        <AlertDialog open={dialogOpen} onOpenChange={setDialogOpen}>
          <AlertDialogTrigger asChild>
            <div className="flex items-center space-x-2 cursor-pointer">
              ...
              <Switch
                ...
                className={
                  isBlacklisted ? "data-[state=checked]:bg-red-500" : ""
                }
          ...
          <AlertDialogContent className="sm:max-w-md">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                {isBlacklistAction
                  ? "This action will blacklist the student. They will not be able to log in."
                  : "This action will remove the student from the blacklist. They will be able to log in again."}
              </AlertDialogDescription>
            </AlertDialogHeader>
