  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const response = await axios.patch(
        `${BACKEND_URL}/course/Interact/Update/Status/${id}`,
        body,
        { headers }
      );
        ...
        <AlertDialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <AlertDialogContent className="sm:max-w-md">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                {isBlacklistAction
                  ? "This action will blacklist the course. They will not be able to log in."
                  : "This action will remove the course from the blacklist. They will be able to log in again."}
              </AlertDialogDescription>
            </AlertDialogHeader>
