...
import { setCreateCourseFaculty } from "@/redux/features/CourseSlice";
...
export function Faculty() {
  ...
  useEffect(() => {
    ...
    setSelectedFaculty(String(course.createCourse.facultyId) || "");
  }, [course.createCourse.facultyId]);

  const handleChange = (value: string) => {
    setSelectedFaculty(value);
    dispatch(setCreateCourseFaculty(value));
  };
