...
const ConfigContent: FC = () => {
  const items = [
    { icon: <FileDiff   size={30} color="#FFFFFF" />, title: "Batch Management", link: "/admin/dashboard/configs/batches" },
    { icon: <FileDiff    size={30} color="#FFFFFF" />, title: "Exam Rules & Policies", link: "/admin/dashboard/configs/logs" },
    { icon: <FileDiff    size={30} color="#FFFFFF" />, title: "Students", link: "/admin/dashboard/configs/students" },
  ];
