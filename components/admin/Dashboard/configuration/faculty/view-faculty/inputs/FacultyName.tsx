...
import { setViewFacultyName } from "@/redux/features/FacultySlice";
...
export function FacultyName() {
  ...
  useEffect(() => {
    setFacultyName(Faculty.viewFaculty.name || "");
  }, [Faculty.viewFaculty.name]);
  ...
  const handleChange = (value: string) => {
    ...
    dispatch(setViewFacultyName(value));
  };
      ...
      <div className="relative group">
        <Input
          ...
          className={`
            ...
            ${Faculty.editBlocked ? "bg-slate-100 text-slate-500 cursor-not-allowed" : "bg-white text-slate-900"}
